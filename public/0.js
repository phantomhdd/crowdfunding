...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    progress: function progress() {
      var progress = Math.ceil(this.campaign.collected / this.campaign.required * 100);
    ...
    [
      _c(
        "v-card",
        {
          ...
          attrs: { "max-width": "344", to: "/campaign/" + _vm.campaign.id }
        },
        [
          _c(
            "v-img",
          ...
          _c(
            ...
            [
              _c(
                "v-progress-linear",
                {
                  attrs: { height: "13", color: _vm.color, rounded: "" },
                  model: {
                    value: _vm.progress,
                    callback: function($$v) {
                      _vm.progress = $$v
                ...
                [
                  _c("span", { staticClass: "text-light text-caption" }, [
