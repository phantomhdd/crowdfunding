            ...
            [
              _c(
                "v-img",
                {
                  ...
                  attrs: { "aspect-ratio": 4 / 2, src: _vm.campaign.image }
                },
                [
                  _c("v-card-title", {
                    ...
                    _c("tbody", [
                      ...
                      _c("tr", [
                        ...
                        _c("td", { staticClass: "orange--text" }, [
                          _vm._v(
                            _vm._s(
                              _vm.$n(_vm.campaign.required, "currency", "ja-JP")
                            )
                          )
                        ])
                      ]),
                      ...
                      _c("tr", [
                        _c(
                          "td",
                          {
                            staticClass: "text--secondary pl-7",
                          ...
                          _c(
                            ...
                            [
                              _c("v-card-title", {
                                staticClass: "fill-height align-end",
                                domProps: {
                                  textContent: _vm._s(campaign.title)
                                }
                              })
                            ],
                            1
                  ...
                  _c(
                    ...
                    [
                      _c(
                        ...
                        {
                          staticClass: "white--text",
                          attrs: { "aspect-ratio": 16 / 9, src: campaign.image }
                        },
                        [
                          _c("v-card-title", {
                            staticClass: "fill-height align-end",
